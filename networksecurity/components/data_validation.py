...
class DataValidation:
    ...
    def is_numerical_column_exist(self,dataframe:pd.DataFrame)-> bool:
        try:
            numerical_columns = self.__schema_config["numberical_columns"]
            ...
            logging.info(f"Missing numberical columns: [{missing_numerical_columns}]")
    ...
    def initiate_data_validation(self)-> DataValidationArtifact:
        try:
            train_file_path = self.data_ingestion_aritfact.trained_file_path
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                valid_train_file_path=self.data_ingestion_aritfact.trained_file_path,
                valid_test_file_path=self.data_ingestion_aritfact.test_file_path,
